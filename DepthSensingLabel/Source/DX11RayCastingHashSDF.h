...
class DX11RayCastingHashSDF
{
	public:
		...
		// Position
		static ID3D11Texture2D* getPositonsImage()
		{
			return s_pPositions;
		}
		...
		// Label
		static ID3D11ShaderResourceView** getLabelsImageSRV()
		{
			return s_pLabelsSRV;
		}

		static ID3D11UnorderedAccessView** getLabelsImageUAV()
		{
			return s_pLabelsUAV;
		}
	...
	private:
		...
		static ID3D11Texture2D* s_pLabels[LABEL_TEXTURE_NUM];
		static ID3D11ShaderResourceView* s_pLabelsSRV[LABEL_TEXTURE_NUM];
		static ID3D11UnorderedAccessView* s_pLabelsUAV[LABEL_TEXTURE_NUM];
		...
		static ID3D11Texture2D* s_pLabelsStereo[LABEL_TEXTURE_NUM];
		static ID3D11ShaderResourceView* s_pLabelsStereoSRV[LABEL_TEXTURE_NUM];
		static ID3D11UnorderedAccessView* s_pLabelsStereoUAV[LABEL_TEXTURE_NUM];
		...
		// test
		static ID3D11Texture2D* s_pTestSplattingMin;
		static ID3D11ShaderResourceView* s_pTestSplattingMinSRV;
		static ID3D11UnorderedAccessView* s_pTestSplattingMinUAV;

		static ID3D11Texture2D* s_pTestSplattingMax;
		static ID3D11ShaderResourceView* s_pTestSplattingMaxSRV;
		static ID3D11UnorderedAccessView* s_pTestSplattingMaxUAV;
		// test
