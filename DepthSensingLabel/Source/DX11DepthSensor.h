...
public:
	...
	//! maps the label to depth data and copies the data to the GPU
	HRESULT processLabel(ID3D11DeviceContext* context);

	//! Gets the previous depth frame and loads it to the GPU (calls 'processPreDepth') of the 
	HRESULT processPreDepth(ID3D11DeviceContext* context);

	//! maps the previous color to depth data and copies depth and color data to the GPU
	HRESULT processPreColor(ID3D11DeviceContext* context);
	
	//! maps the previous label to depth data and copies the data to the GPU
	HRESULT processPreLabel(ID3D11DeviceContext* context);
	...
	ID3D11ShaderResourceView* GetPreDepthUSSRV() {
		return m_pPreDepthTextureUSSRV;
	}
	...
	ID3D11ShaderResourceView* GetPreDepthFSRV() {
		return m_pPreDepthTextureFSRV;
	}
	...
	ID3D11Texture2D* GetPreDepthFFiltered() {
		return m_pPreDepthTextureFFiltered2D;
	}
	...
	ID3D11ShaderResourceView* GetPreDepthFFilteredSRV() {
		return m_pPreDepthTextureFFilteredSRV;
	}
	...
	ID3D11Texture2D* GetPreDepthFloat4() {
		return m_pPreDepthTextureFloat42D;
	}
	...
	ID3D11ShaderResourceView* GetPreDepthFErodedSRV() {
		return m_pPreDepthTextureFErodedSRV;
	}
	...
	ID3D11ShaderResourceView* GetPreDepthFloat4SRV() {
		return m_pPreDepthTextureFloat4SRV;
	}
	...
	ID3D11ShaderResourceView* GetHSVPreDepthFloat4SRV() {
		return m_pHSVPreDepthTextureFloat4SRV;
	}
	...
	ID3D11Texture2D* GetHSVPreDepthFloatTexture() {
		return m_pHSVPreDepthTextureFloat42D;
	}
	...
	ID3D11ShaderResourceView* GetPreNormalFloat4SRV() {
		return m_pPreNormalTextureFloat4SRV;
	}
	...
	ID3D11ShaderResourceView* GetPreColorSRV() {
		return m_pPreColorTextureSRV;
	}

	ID3D11Texture2D* GetPreColorTexture() {
		return m_pPreColorTexture2D;
	}

	ID3D11ShaderResourceView** GetLabelSRV() {
		return m_pLabelTextureSRV;
	}

	ID3D11ShaderResourceView** GetPreLabelSRV() {
		return m_pPreLabelTextureSRV;
	}
...
private:
	...
	ID3D11Texture2D*                    m_pPreDepthTextureUS2D;
	ID3D11ShaderResourceView*           m_pPreDepthTextureUSSRV;
	...
	ID3D11Texture2D*					m_pPreDepthTextureF2D;
	ID3D11ShaderResourceView*           m_pPreDepthTextureFSRV;
	ID3D11UnorderedAccessView*          m_pPreDepthTextureFUAV;
	...
	ID3D11Texture2D*					m_pPreDepthTextureFEroded2D;
	ID3D11ShaderResourceView*           m_pPreDepthTextureFErodedSRV;
	ID3D11UnorderedAccessView*          m_pPreDepthTextureFErodedUAV;
	...
	ID3D11Texture2D*					m_pPreDepthTextureFFiltered2D;
	ID3D11ShaderResourceView*           m_pPreDepthTextureFFilteredSRV;
	ID3D11UnorderedAccessView*          m_pPreDepthTextureFFilteredUAV;
	...
	ID3D11Texture2D*					m_pHSVPreDepthTextureFloat42D;
	ID3D11ShaderResourceView*           m_pHSVPreDepthTextureFloat4SRV;
	ID3D11UnorderedAccessView*          m_pHSVPreDepthTextureFloat4UAV;
	...
	ID3D11Texture2D*					m_pPreDepthTextureFloat42D;
	ID3D11ShaderResourceView*           m_pPreDepthTextureFloat4SRV;
	ID3D11UnorderedAccessView*          m_pPreDepthTextureFloat4UAV;
	...
	ID3D11Texture2D*					m_pPreNormalTextureFloat42D;
	ID3D11ShaderResourceView*           m_pPreNormalTextureFloat4SRV;
	ID3D11UnorderedAccessView*          m_pPreNormalTextureFloat4UAV;

	// for passing color data as a texture
	ID3D11Texture2D*                    m_pColorTexture2D;
	ID3D11ShaderResourceView*           m_pColorTextureSRV;

	// for passing label data as a texture
	ID3D11Texture2D*                    m_pLabelTexture2D[LABEL_TEXTURE_NUM];
	ID3D11ShaderResourceView*           m_pLabelTextureSRV[LABEL_TEXTURE_NUM];

	ID3D11Texture2D*                    m_pPreColorTexture2D;
	ID3D11ShaderResourceView*           m_pPreColorTextureSRV;

	ID3D11Texture2D*                    m_pPreLabelTexture2D[LABEL_TEXTURE_NUM];
	ID3D11ShaderResourceView*           m_pPreLabelTextureSRV[LABEL_TEXTURE_NUM];
